...
# Set the environment variable for .cdsinit location
export CDS_SITE="/home/zhoulong/projects/auto_rfic/cadence"
export SKILL_SERVER_PATH="/home/zhoulong/projects/auto_rfic/cadence/skill/skillServer.il"

echo "TSMC PDK environment configured: $TSMC_PDK"
echo "Using .cdsinit from: $CDS_SITE"
...
echo "SKILL Server will be loaded via .cdsinit"